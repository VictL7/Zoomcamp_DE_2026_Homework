...
BUCKET_NAME = "2026_zoomcamp_de_w4_analytics_engineering_dbt_hw"

# Set credentials path
CREDENTIALS_FILE = "/workspaces/Zoomcamp_DE_2026_Homework/3_data_warehouse_Bigquery/zeta-medley-473321-r6-2433b342cf3f.json"
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = CREDENTIALS_FILE

# Initialize client with service account credentials
client = storage.Client.from_service_account_json(CREDENTIALS_FILE)

# Configuration for downloading 2019-2020 yellow and green taxi data
...
if __name__ == "__main__":
    ...
    # Generate list of (year, service, month) tuples for all combinations
    download_tasks = [
        (year, service, month)
        for year in YEARS
    ...
    print(f"Starting to download {len(download_tasks)} files (2019-2020, yellow+green, all months)...")
